#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#
#                           SINGLE da integratore con triangolare in ingresso                  #
#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#
from LIB import *
...
#FileName = "300hz.txt"
Directory = "esp_6_da_triangolare/"
...
if(bool_double_graph):
    if(bool_lin):
        ...
        g1.set_title("Onda  da integratore con triangolare in ingresso")
        g2.set_title("FFT")
        g1.grid(color = "gray")
...
if(bool_single_time):
    ...
    pylab.title("Onda da integratore con triangolare in ingresso")
    pylab.xlim(TLIM)
    pylab.minorticks_on()
...
if(bool_single_FFT):
    if(bool_lin):
        ...
        pylab.title("FFT onda da integratore con triangolare in ingresso")
        if(bool_focus_FFT):
            pylab.xlim(FFOCUS)
        else:
            pylab.xlim(FLIM)
...
if(bool_filter_low):
    ...
    pylab.title("Simulazione di integratore con onda da integratore con triangolare in ingresso in ingresso")
...
if(bool_filter_high):
    ...
    pylab.grid(b=True, which='minor', color='#999999', linestyle='-', alpha=0.2)
    pylab.xlim(min(t), max(t))
    pylab.title("Simulazione di derivatore con onda da integratore con triangolare in ingresso in ingresso")
    pylab.xlabel("Tempi [s]")
    pylab.ylabel("d.d.p. [digit]")
    pylab.minorticks_on()
    ampiezza_t = abs(numpy.fft.irfft(gfilter))
