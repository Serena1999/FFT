...
#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#
# --> choosen file::
#FileName = "transosc05.txt"
#FileName = "transosc16.txt"
#FileName = "transosc07.txt"
FileName = "transosc15.txt"
...
if(bool_double_graph):
    if(bool_lin):
        ...
        g1.set_title("Oscillatore a reazione")
        g2.set_title("FFT")
        g1.grid(color = "gray")
...
if(bool_single_time):
    ...
    pylab.title("Oscillatore a reazione")
    pylab.xlim(TLIM)
    pylab.minorticks_on()
...
if(bool_fit):##mancano residui
    ...
    pylab.title("Onda a pinna di squalo")
    pylab.xlim(TLIM)
    pylab.xlabel("Tempo [s]")
    pylab.ylabel("d.d.p. [digit]")
...
if(bool_filter_low):
    ...
    pylab.title("Simulazione di integratore con onda a pinna di squalo in ingresso")
...
if(bool_filter_high):
    ...
    pylab.grid(b=True, which='minor', color='#999999', linestyle='-', alpha=0.2)
    pylab.xlim(min(t), max(t))
    pylab.title("Simulazione di derivatore con onda a pinna di squalo in ingresso")
    pylab.xlabel("Tempi [s]")
    pylab.ylabel("d.d.p. [digit]")
    pylab.minorticks_on()
    ampiezza_t = abs(numpy.fft.irfft(gfilter))
...
if(bool_freq):
    ...
    pylab.title("FFT onda a pinna di squalo")
    pylab.xlabel("Frequenza [Hz]")
    pylab.ylabel("Ampiezza in dB")
    pylab.minorticks_on()
    pylab.grid(color = "gray")
