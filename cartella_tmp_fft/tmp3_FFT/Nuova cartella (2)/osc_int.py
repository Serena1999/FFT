...
#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#
# --> choosen file::
FileName = "smorzint10.txt"
Directory = "data_oscRLC_con_nucleo_F/"
...
bool_fit = False##CONTROLLA O MAGARI PROVA CON ALTRI FILE
...
pylab.errorbar(t1, y1)
pylab.show()
pylab.errorbar(t2, y2)
pylab.show()
pylab.errorbar(t3, y3)
pylab.show()
pylab.errorbar(t4, y4)
pylab.show()
...
if(bool_window):
    ...
    tra_complessa1 = numpy.fft.rfft(y1)
    tra_complessa2 = numpy.fft.rfft(y2)
    tra_complessa3 = numpy.fft.rfft(y3)
    tra_complessa4 = numpy.fft.rfft(y4)
    tra_complessa = tra_complessa1 +tra_complessa2 +tra_complessa3 + tra_complessa4
