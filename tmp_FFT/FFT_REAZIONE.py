#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#
#                          FFT ONDA RLC REAZIONE                      #
#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#
from FFT_RLC_INT import *

if(bool_oscReazione):
    print("\n FFT ONDA RLC REAZIONE:\n")
    for Name in FileNameOscRea:
        print(Name)
        t, y = pylab.loadtxt(Directories[4]+Name, unpack = True)
        t = t / 1000000 #secondi
        ...
        g1.set_title("Onda oscillatore a reazione")
        g2.set_title("FFT")
        TLIM = [min(t), max(t)]
        g1.set_xlim(TLIM)
